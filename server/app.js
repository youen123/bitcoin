...
var app = require('http').createServer(handler).listen(8088),
...
io.sockets.on('connection', function(socket){
	var xcoinAPI = new XCoinAPI('0dac03467d3c97ba2b88ebc780fcce8d', '1eac5a6b038ca77ec6d188c0ef614ba1');
	var rgParams = {
		order_currency:'BTC',
	...
	xcoinAPI.xcoinApiCall('/public/ticker/BTC');
});
